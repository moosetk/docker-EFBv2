...
RUN wget https://go.niou.tk/blueset.telegram/config.yaml -P /root/blueset.telegram/
RUN wget https://go.niou.tk/blueset.telegram/tgdata.db -P /root/blueset.telegram/
RUN wget https://go.niou.tk/blueset.wechat/wxpy.pkl -P /root/blueset.wechat/
RUN wget https://go.niou.tk/blueset.wechat/wxpy_puid.pkl -P /root/blueset.wechat/
