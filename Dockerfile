...
RUN wget https://xxx/blueset.telegram/config.yaml -P /root/blueset.telegram/
RUN wget https://xxx/blueset.telegram/tgdata.db -P /root/blueset.telegram/
RUN wget https://xxx/blueset.wechat/wxpy.pkl -P /root/blueset.wechat/
RUN wget https://xxx/blueset.wechat/wxpy_puid.pkl -P /root/blueset.wechat/
